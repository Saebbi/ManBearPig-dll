...
// Type: ManBearPig.IncidentWorker_MonsterSighting
...
namespace ManBearPig
{
  public class IncidentWorker_MonsterSighting : IncidentWorker
  {
    ...
    {
      return (PawnKindDef) GenCollection.RandomElement<PawnKindDef>((IEnumerable<M0>) DefDatabase<PawnKindDef>.get_AllDefs().Where<PawnKindDef>((Func<PawnKindDef, bool>) (defs => ((string) ((Def) defs).defName).Equals("ManBearPig"))));
    }
